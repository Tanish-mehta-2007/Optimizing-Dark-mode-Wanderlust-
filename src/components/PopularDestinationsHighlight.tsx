...
const DestinationCard: React.FC<DestinationCardProps> = ({ destination, index, onExplore, animationBaseClass }) => {
  return (
    <div 
      className={`relative group rounded-xl overflow-hidden shadow-lg transition-all duration-300 ease-in-out aspect-[3/4] sm:aspect-[4/3] lg:aspect-[3/4] ${animationBaseClass || ''} card-interactive-lift`}
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 text-white">
        ...
        <button 
          ...
          className="mt-3 inline-flex items-center text-xs sm:text-sm font-medium text-blue-300 group-hover:text-blue-200 bg-black/30 group-hover:bg-black/50 px-3 py-1.5 rounded-md transition-colors button-interactive"
