...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, index, animationBaseClass }) => {
  return (
    <div 
      className={`bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg transition-all duration-300 flex flex-col items-start group ${animationBaseClass || ''} card-interactive-lift`}
