...
const GlobalFooter: React.FC<GlobalFooterProps> = ({
  ...
  const footerLinkClasses = "text-xs sm:text-sm text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:underline transition-colors interactive-element px-1 py-0.5 rounded button-interactive"; 
