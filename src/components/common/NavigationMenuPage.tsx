...
const NavMenuStandaloneTrainIcon = ({isActive}: {isActive: boolean}) => <NavMenuIconWrapper isActive={isActive}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={isActive ? 2.25 : 1.75} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-1.5-5.25H12M5.25 6.75V17.25m13.5-10.5v10.5m-13.5 0L5.25 15M12 17.25l-1.5-2.25M18.75 17.25l-1.5-2.25" /><path strokeLinecap="round" strokeLinejoin="round" d="M3 13.5A6.75 6.75 0 019.75 6.75h4.5A6.75 6.75 0 0121 13.5" /></svg></NavMenuIconWrapper>;
const NavMenuStandaloneBusIcon = ({isActive}: {isActive: boolean}) => <NavMenuIconWrapper isActive={isActive}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={isActive ? 2.25 : 1.75} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.125-.504 1.125-1.125V14.25m0-2.25h.008v.008h-.008V12m0 0c0-2.414-1.093-4.53-2.764-5.858M3.375 16.5c1.135 0 2.187.229 3.137.635m11.49-.492c.95.406 1.992.635 3.137.635M12 4.5V2.25m0 2.25V2.25m0 2.25v2.25M5.25 6.75C5.25 9.96 8.28 12.45 12 12.45s6.75-2.49 6.75-5.7S15.72 1.5 12 1.5S5.25 3.04 5.25 6.75z" /></svg></NavMenuIconWrapper>;
...
export const NavigationMenuPage: React.FC<NavigationMenuPageProps> = ({ 
    ...
    onNavigateToStandaloneFlight, onNavigateToStandaloneHotel, onNavigateToStandaloneCar, onNavigateToStandaloneTrain, onNavigateToStandaloneBus, onNavigateToCabBooking,
  ...
  const quickBookLinks = [
    ...
    ...(onNavigateToStandaloneBus ? [{ view: AppView.STANDALONE_BUS_BOOKING, icon: NavMenuStandaloneBusIcon, label: "Book a Bus", action: onNavigateToStandaloneBus }] : []),
  ...
  const containerClasses = isSlideOutMode 
    ...
    : `flex-1 flex flex-col bg-white dark:bg-slate-850 page-transition-enter overflow-y-auto custom-scrollbar`; 
