...
const MyAccountPage: React.FC<MyAccountPageProps> = ({ theme, setTheme, userPreferences, setUserPreferences }) => {
  ...
  const renderContent = () => {
    ...
    switch (currentSettingView) {
      ...
      case 'billingAddress': return <BillingAddressSection />; 
      default: return null;
    }
  };
  ...
  return (
    <div className="flex-1 flex flex-col max-w-3xl mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8 page-transition-enter overflow-y-auto custom-scrollbar">
