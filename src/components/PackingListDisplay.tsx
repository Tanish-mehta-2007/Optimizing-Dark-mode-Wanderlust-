...
const PackingListDisplay: React.FC<PackingListDisplayProps> = ({ onNext, onBack }) => {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-white dark:bg-slate-800 p-6 sm:p-10 rounded-xl shadow-xl">
  ...
  if (error) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center p-6 sm:p-8 bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-md mx-auto border border-red-200 dark:border-red-700">
  ...
  if (!currentTrip || !currentTrip.packingList || currentTrip.packingList.length === 0) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center p-6 sm:p-8 bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-md mx-auto border border-slate-200 dark:border-slate-700">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
            ...
            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-6 rounded-lg shadow-md transition-colors button-interactive"
            >
  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-slate-800 p-4 sm:p-6 md:p-10 rounded-xl shadow-xl max-w-3xl mx-auto text-slate-700 dark:text-slate-200 overflow-y-auto custom-scrollbar">
      ...
      <div className="mt-8 sm:mt-10 pt-6 border-t border-slate-200 dark:border-slate-700 flex flex-col-reverse sm:flex-row sm:justify-between items-center gap-3">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <button
                ...
                className="w-full sm:w-auto flex items-center justify-center px-4 py-2.5 bg-sky-500 hover:bg-sky-600 text-white font-medium rounded-lg shadow-sm transition-colors disabled:opacity-60 text-sm button-interactive"
            >
                <ShoppingBagIcon /> {isFetchingAllSuggestions ? 'Suggesting...' : 'Suggest Shopping Links'}
            </button>
            <button
                onClick={handleSaveAndFinish}
                className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg shadow-md transition-colors transform hover:scale-105 button-interactive"
            >
                Next: Manage Budget
            </button>
        </div>
