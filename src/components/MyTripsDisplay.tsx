...
// Removed: import { fetchFlightStatus } from '../services/geminiService';
...
export const MyTripsDisplay: React.FC<MyTripsDisplayProps> = ({ onPlanNewTrip, onViewTripDetails }) => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-slate-900 py-6 sm:py-8 px-4 sm:px-6 lg:px-8 overflow-y-auto custom-scrollbar">
...
// export default MyTripsDisplay; // Keep as named export for App.tsx
