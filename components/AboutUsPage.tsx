...
const AboutUsPage: React.FC<AboutUsPageProps> = ({ onNavigateBack, onNavigateToContactUs }) => {
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100 min-h-screen page-transition-enter">
      <header className="relative h-64 sm:h-80 md:h-96 group">
        <img
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-end pb-8 sm:pb-12">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-10 sm:space-y-12">
        ...
        <section className="text-center py-6 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
          ...
          <p className="mt-2">
             <button onClick={onNavigateToContactUs} className="text-sm sm:text-base text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium underline">
              Contact Us
            </button>
          </p>
        </section>
