        ...
        <div className="space-y-4">
          {options.map((option) => {
            ...
            return (
              <div 
                key={option.id} 
                className={`p-3 sm:p-4 rounded-lg shadow-md transition-all duration-300 ease-in-out border
                ...
                <div className="mt-4 flex flex-col sm:flex-row justify-end items-stretch sm:items-center">
                  {isCurrentlyProcessing ? (
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2 px-4 rounded-md shadow-md transition-colors duration-200"
                    ...
                    <button
                      ...
                      className={`w-full sm:w-auto font-semibold py-2 px-4 rounded-md shadow-md transition-colors duration-200 
