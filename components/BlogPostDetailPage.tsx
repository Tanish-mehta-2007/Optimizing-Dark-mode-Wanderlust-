...
const BlogPostDetailPage: React.FC<BlogPostDetailPageProps> = ({ postId, onNavigateBack }) => {
  ...
  if (!post) {
    return (
      <div className="text-center py-20 px-4 bg-slate-50 dark:bg-slate-900 min-h-screen">
        ...
        <button
          ...
          className="mt-8 inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition-colors"
        >
  ...
  return (
    <div className="bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 min-h-screen py-8 sm:py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <button
            onClick={onNavigateBack}
            className="mb-6 inline-flex items-center text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium group"
        >
            <BackArrowIcon />
