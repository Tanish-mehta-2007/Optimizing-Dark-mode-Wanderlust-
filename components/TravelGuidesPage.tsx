...
const TravelGuidesPage: React.FC<TravelGuidesPageProps> = ({ onNavigateToGuideDetail }) => {
  ...
  return (
    <div className="bg-[#F0F7F4] dark:bg-slate-900 min-h-screen py-8 sm:py-12">
        ...
        <div className="mb-8 sm:mb-10 flex flex-wrap gap-2 sm:gap-3">
          {FILTER_CATEGORIES.map((category) => (
            <button
              ...
              className={`px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium rounded-full transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-slate-900
