          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg border border-slate-200 dark:border-slate-600">
              ...
              <div>
                ...
                <button onClick={onNavigateToSupport} className="text-sm sm:text-base text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300 font-medium underline">
                  Go to Support Page
                </button>
              </div>
            </div>
